...
http {
    ...
    gzip_types text/html text/plain text/css text/javascript application/json application/javascript application/x-javascript application/xml;  # 对哪些类型的文件用压缩, 音视频就别压缩了, 压不了多少
